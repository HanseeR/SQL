...
select * from onboarding where Salary > 1000;

-- filtering the numeric values 

select * from onboarding where salary between 500 and 1500; 

select * from onboarding where LastName LIKE '%a';

select * from onboarding where Salary > 1000 and Department = 'SII';

select * from onboarding where PhoneNumber is NULL;
